...
import com.baiyigame.pay.util.IabBroadcastReceiver.IabBroadcastListener;
import com.baiyigame.pay.util.IabException;
import com.baiyigame.pay.util.IabHelper;
import com.baiyigame.pay.util.IabHelper.IabAsyncInProgressException;
...
public class MainActivity extends Activity implements IabBroadcastListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String base64EncodedPublicKey =
                "";
        ...
        if (!getPackageName().startsWith("com.baiyigame.pay")) {
...
//                    }
       ...
       // mHelper.QueryProducts(getPackageName());
    }
